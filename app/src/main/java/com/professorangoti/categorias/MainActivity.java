...
public class MainActivity extends AppCompatActivity
    ...
    private void consultaWebService() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://gs-sts-cloud-foundry-deployment-angoti.cfapps.io/")
                .addConverterFactory(GsonConverterFactory.create(gson))
                .build();
        EndPoint apiService = retrofit.create(EndPoint.class);
        Call<Categoria> call = apiService.listaCategorias(1);
        //chamada assíncrona
    ...
    private void exibeDados(Categoria categoria) {
